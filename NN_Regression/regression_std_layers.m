...
for k = 1:7
    ...
    save(strcat("performance_std_one_layer_",train_function(k),".mat"), "performance_one_layer");
    save(strcat("performance_std_two_layer_",train_function(k),".mat"), "performance_two_layer");
end
